...
//            lp.width = viewRect.right - viewRect.left;
//            //lp.height = viewRect.bottom - viewRect.top;
//            view.setLayoutParams(lp);
           // placer.addView(view);
            int pos = layoutManager.getPosition(view);
            int l = layoutManager.getLeftDecorationWidth(view);
            int r = layoutManager.getRightDecorationWidth(view);
            int t = layoutManager.getTopDecorationHeight(view);
            int b = layoutManager.getBottomDecorationHeight(view);
            Log.e("xxx", "measure:" + "position===" + pos +  viewRect.toString());
            int w = View.MeasureSpec.makeMeasureSpec(viewRect.right -  viewRect.left - l - r, View.MeasureSpec.EXACTLY);
            int h = View.MeasureSpec.makeMeasureSpec(viewRect.bottom - viewRect.top - t - b, View.MeasureSpec.EXACTLY);
            view.measure(w, h);
            //layoutManager.measureChildWithMargins(view, 0, 0);
        }
        ...
        for (Pair<Rect, View> rowViewRectPair : rowViews) {
            ...
            placer.addView(view);
            //add view to layout
            //Log.e("xxx", "layout:" + "position===" + pos +  viewRect.toString());
