...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void addIgnoreType(int itemType) {
        this.ignoreType = ignoreType | itemType;
    }
    ...
    public static class Builder {
        ...
        public Builder ignoreType(int type) {
            itemDecoration.addIgnoreType(type);
            return this;
        }
    ...
    private boolean ignore(int type) {
        if (type != 0) {
            if (type == BaseQuickAdapter.EMPTY_VIEW || type == BaseQuickAdapter.HEADER_VIEW ||
                    type == BaseQuickAdapter.FOOTER_VIEW || type == BaseQuickAdapter.LOADING_VIEW) {
                return true;
            }

            return type == (type & ignoreType);
        }
        return false;
    }
