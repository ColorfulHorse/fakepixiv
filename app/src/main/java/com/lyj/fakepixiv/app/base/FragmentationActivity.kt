 ...
 * @desc
 */
abstract class FragmentationActivity<V : ViewDataBinding, VM : BaseViewModel?>: BaseActivity<V, VM>(), ISupportActivity {
    ...
    override fun onCreateFragmentAnimator(): FragmentAnimator = DefaultVerticalAnimator()
