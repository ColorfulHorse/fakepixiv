package com.lyj.fakepixiv.app.glide;
...
public class PositionedCrop extends BitmapTransformation {
    private static final String ID = "com.lyj.fakepivix.app.glide.PositionedCrop";
    ...
    public PositionedCrop(@FloatRange(from = 0.0, to = 1.0)float xPercentage, @FloatRange(from = 0.0, to = 1.0)float yPercentage) {
        super();
    ...
    public boolean equals(Object o) {
        return o instanceof PositionedCrop;
    }
